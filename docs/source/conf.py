...
# -*- coding: utf-8 -*-
#
# Cornice documentation build configuration file, created by
# sphinx-quickstart on Tue Dec  6 10:57:54 2011.
#
...
sys.path.insert(0, os.path.abspath("../.."))
extensions = ['cornice.sphinxext', 'sphinx.ext.autodoc', 'sphinxcontrib.httpdomain']
